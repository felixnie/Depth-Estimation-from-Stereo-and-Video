...
%
% Note:
% The weights of the directed graph are the difference of adjacent pixels.
...
pairwise = construct_graph_weighted(H, W, imgL);
...
title(['Denoised Disparity Map (Weighted graph, λ = ' num2str(lambda) ')'])